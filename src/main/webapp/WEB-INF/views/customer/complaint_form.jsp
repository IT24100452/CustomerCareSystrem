...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="${pageContext.request.contextPath}/complaint" method="post" enctype="multipart/form-data" id="complaintForm">
            ...
            <div class="form-group">
                <label for="expectedResolution">Expected Resolution Time *</label>
                <select id="expectedResolution" name="expectedResolution" class="form-control" required>
            ...
            <div class="form-group">
                ...
                <div class="file-upload">
                    <input type="file" id="attachment" name="attachment" multiple accept=".pdf,.doc,.docx,.jpg,.jpeg,.png,.gif,.txt">
                    <label for="attachment" class="file-upload-label">
                        <i class="fas fa-cloud-upload-alt"></i> Click to upload files
                    </label>
                    <p class="text-muted">Supported formats: PDF, DOC, DOCX, JPG, PNG, GIF, TXT (Max 10MB per file, up to 3 files)</p>
                </div>
            </div>
