...
<head>
    ...
    <title>Track Complaint Status - Smart Lanka CCS</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-search"></i> Track Complaint Status</h1>
            <p>Monitor the progress of your submitted complaints</p>
        </div>
        ...
        <div class="tracking-container">
            <div class="tracking-header">
                <h2><i class="fas fa-clipboard-list"></i> Complaint Tracking</h2>
                ...
                <% for (Complaint complaint : complaints) { %>
                    <div class="complaint-card">
                        ...
                        <div class="progress-timeline">
                            <h4 style="margin-bottom: 15px; color: #2c3e50;"><i class="fas fa-timeline"></i> Progress Timeline</h4>
