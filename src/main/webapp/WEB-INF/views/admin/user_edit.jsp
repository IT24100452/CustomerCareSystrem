...
<head>
    ...
    <title>Edit User - Smart Lanka CCS</title>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div style="display: flex; gap: 10px;">
                            <a href="${pageContext.request.contextPath}/user?action=view&id=${user.userId}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        <% if (request.getAttribute("user") != null) { %>
                            ...
                            <div class="alert alert-danger">
                                ...
                                <% } else if ("email_exists".equals(request.getParameter("error"))) { %>
                            ...
                            <div class="alert alert-success" style="border-left: 4px solid #10b981; background: linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(16, 185, 129, 0.05)); margin-bottom: 20px;">
                                <div style="display: flex; align-items: center; gap: 10px;">
                                    ...
                                    <div>
                                        <strong style="color: #10b981;">User Updated Successfully!</strong>
                                        <p style="margin: 5px 0 0 0; color: #059669;">
                                            The user information has been updated and saved to the system.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <form action="${pageContext.request.contextPath}/user" method="post" id="editUserForm">
                                        ...
                                        <div style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="username" name="username" class="form-control" required 
                                                       value="<%= user.getUsername() %>" placeholder="Enter username">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="email">Email Address *</label>
                                                <input type="email" id="email" name="email" class="form-control" required 
                                                       value="<%= user.getEmail() %>" placeholder="Enter email address">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="tel" id="phoneNumber" name="phoneNumber" class="form-control" required 
                                                       value="<%= user.getPhoneNumber() != null ? user.getPhoneNumber() : "" %>" placeholder="Enter phone number">
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <div>
                                        <h3><i class="fas fa-user-tag"></i> Role & Department</h3>
                                        <div style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px;">
                                            <div class="form-group">
                                                <label for="roleId">Role *</label>
                                                <select id="roleId" name="roleId" class="form-control" required>
                                                    <option value="">Select role</option>
                                                    <option value="1" <%= user.getRoleId() == 1 ? "selected" : "" %>>System Administrator</option>
                                                    <option value="2" <%= user.getRoleId() == 2 ? "selected" : "" %>>Administrator</option>
                                                    <option value="3" <%= user.getRoleId() == 3 ? "selected" : "" %>>Support Staff</option>
                                                    <option value="4" <%= user.getRoleId() == 4 ? "selected" : "" %>>Finance Staff</option>
                                                    <option value="5" <%= user.getRoleId() == 5 ? "selected" : "" %>>Manager</option>
                                                    <option value="6" <%= user.getRoleId() == 6 ? "selected" : "" %>>Marketing Executive</option>
                                                    <option value="7" <%= user.getRoleId() == 7 ? "selected" : "" %>>Customer</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="employeeId" name="employeeId" class="form-control" 
                                                       value="<%= user.getEmployeeId() != null ? user.getEmployeeId() : "" %>" placeholder="Enter employee ID (optional)">
                                            </div>
                                ...
                                <div style="margin-top: 30px;">
                                    <h3><i class="fas fa-key"></i> Password (Optional)</h3>
                                    <div style="background: rgba(255,255,255,0.05); padding: 20px; border-radius: 8px;">
                                        <div class="form-group">
                                            <label for="newPassword">New Password</label>
                                            <input type="password" id="newPassword" name="newPassword" class="form-control" 
                                                   placeholder="Leave blank to keep current password" minlength="8">
                                            <small style="color: #cbd5e1;">Leave blank to keep the current password</small>
                                        </div>
                                ...
                                <div style="margin-top: 30px; text-align: center;">
                                    ...
                                    <a href="${pageContext.request.contextPath}/user?action=view&id=<%= user.getUserId() %>" class="btn btn-secondary btn-lg">
