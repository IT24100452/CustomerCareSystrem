...
<head>
    ...
    <title>Admin Dashboard - Smart Lanka CCS</title>
    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #665eea 0%, #264ba2 100%);
            min-height: 100vh;
            color: #333;
        }
                    ...
                    <div class="card-body">
                        ...
                        <div style="margin-top: 30px;">
                            ...
                            <div style="display: flex; gap: 15px; flex-wrap: wrap; margin-top: 15px;">
                                ...
                                <a href="${pageContext.request.contextPath}/user?action=list" class="btn btn-primary">
                                    <i class="fas fa-users"></i> Manage Users
                                </a>
                                <a href="${pageContext.request.contextPath}/notifications" class="btn btn-secondary">
                                    <i class="fas fa-bell"></i> Notifications
                                </a>
                            </div>
                        </div>
