...
<head>
    ...
    <title>View Feedback Metrics - Marketing Dashboard</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-chart-bar"></i> View Feedback Metrics</h1>
            <p>Comprehensive analysis of customer satisfaction and feedback trends</p>
        </div>

        <div class="metrics-container">
            <div class="metrics-header">
                <h2><i class="fas fa-analytics"></i> Customer Feedback Analytics</h2>
                <div>
                    <a href="${pageContext.request.contextPath}/marketing-dashboard/create-report" class="btn btn-success">
