...
<head>
    ...
    <title>Manage Complaints - Support Dashboard</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-clipboard-list"></i> Manage Complaints</h1>
            <p>Update complaint status and manage assigned complaints</p>
        </div>
            ...
            <div class="alert alert-success" style="border-left: 4px solid #10b981; background: linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(16, 185, 129, 0.05)); margin-bottom: 20px; padding: 15px; border-radius: 8px;">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div>
                        ...
                        <p style="margin: 5px 0 0 0; color: #059669;">
                            The complaint has been updated and the changes have been saved.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="complaints-container">
            <div class="complaints-header">
                <h2><i class="fas fa-tasks"></i> All Complaints</h2>
                ...
                <% for (Complaint complaint : complaints) { %>
                    <div class="complaint-card">
                        ...
                        <div class="status-update-form">
                            ...
                            <form action="${pageContext.request.contextPath}/complaint" method="post">
                                ...
                                <div class="form-group">
                                    <label for="status-<%= complaint.getComplaintId() %>">Status:</label>
                                    <select id="status-<%= complaint.getComplaintId() %>" name="status" required>
                                        <option value="OPEN" <%= "OPEN".equals(complaint.getStatusCode()) ? "selected" : "" %>>Open</option>
                                        <option value="IN_PROGRESS" <%= "IN_PROGRESS".equals(complaint.getStatusCode()) ? "selected" : "" %>>In Progress</option>
                                        <option value="RESOLVED" <%= "RESOLVED".equals(complaint.getStatusCode()) ? "selected" : "" %>>Resolved</option>
                                        <option value="CLOSED" <%= "CLOSED".equals(complaint.getStatusCode()) ? "selected" : "" %>>Closed</option>
                                    </select>
                                </div>
                                
                                <div class="form-group">
                                    <label for="resolution-<%= complaint.getComplaintId() %>">Resolution Notes:</label>
                                    <textarea id="resolution-<%= complaint.getComplaintId() %>" name="resolution" 
                                              placeholder="Add resolution details or notes..."><%= complaint.getResolution() != null ? complaint.getResolution() : "" %></textarea>
                                </div>
                        ...
                        <div class="complaint-actions">
                            ...
                            <a href="${pageContext.request.contextPath}/assignment?action=assign&complaintId=<%= complaint.getComplaintId() %>" class="btn btn-secondary">
